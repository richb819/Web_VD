...
<img alt="Landing page large screen" src="examples/landing-lg.png" width=600>
...
Large screen:
![Landing page large screen](examples/landing-lg.png)

Small screen:
![Landing page small screen](examples/landing-sm.png)
￼

#### Comparisons page

Large screen:
![comparison page large screen](examples/comparison-lg.png)

Small screen:
![comparison page small screen](examples/comparison-sm.png)

#### Data page

Large screen:
![data page large screen](examples/data-lg.png)

Small screen:
![data page small screen](examples/data-sm.png)
...
Large screen:
![visualize page large screen](examples/visualize-lg.png)

Small screen:
![visualize page small screen](examples/visualize-sm.png)

#### Navigation menu

Large screen:
![nav menu large screen](examples/nav-lg.png)

Small screen:
![nav menu small screen](examples/nav-sm.png)
